...
class Backup extends AppModel {
    ...
    public $target_path = "";
    public $backup_db_user = "";
    public $backup_db_password = "";
    
    public function setup_env($option) {
        $this->target_path = $option['Option']['target_path'];
        $this->backup_db_user = $option['Option']['db_user'];
        $this->backup_db_password = $option['Option']['db_pass'];
    }
 ...
 */
    ...
    public function backup_path($backup, $check_valid_backup = true) {
        ...
        $target_path = $this->target_path . '/' . $backup['Backup']['name'];
    ...
    public function backup_database($backup, $check_valid_backup = true) {
        $db_user = $this->backup_db_user;
        $db_pass = $this->backup_db_password;
